...
* Build Process:
---------------------
*  CL /EHsc Checkin.cpp  ../DateTime/DateTime.cpp ../StringUtilitites/StringUtilities.cpp
*
*
* Required Files:
* ---------------
...
#include<vector>pa#include<iterator>
...
namespace NoSqlDb
{
	...
	template<typename T>
	Parents DbCore<T>::parents(const Key& key)
	{
		Parents parents;
