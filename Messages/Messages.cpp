...
Message::customAttributes& Message::cattributes()
{
	return _cattributes;
}
...
//------< add or modifies custom attributs >----------

void Message::cattribute(const Key& key, const customAttribute& value)
{
	_cattributes[key] = value;
}
...
{
	if (containsKey("messageText"))
	{
		return attributes_["messageText"];
	}
	return "";
}
//----< set messageText attribute >-------------------------------------------

void Message::messageText(const std::string& nm)
{
	attributes_["messageText"] = nm;
}
